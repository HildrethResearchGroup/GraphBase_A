...
- (void) setupDisclosureBar {
    ...
    //nameField = [[NSTextField alloc] initWithFrame:NSMakeRect(20.0, 3.0, [self frame].size.width - 8.0, 15.0)];
...
- (void)drawRect:(NSRect)dirtyRect {
    //DLog(@"CALLED - Section: drawRect");
    
    [super drawRect:dirtyRect];
    
        
    NSColor* grey = [NSColor colorWithCalibratedRed: 0.8 green: 0.8 blue: 0.8 alpha: 1];
    [grey set];
